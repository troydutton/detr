...
def test_dino_forward() -> None:
    """
    Test the forward pass of the DINO model.
    """
    # Test parameters
    batch_size = 2
    ...
    # Needs valid targets for denoise queries
    ...
    assert denoise_output is not None
    ...
    expected_denoise_logits_shape = (batch_size, num_decoder_layers, num_groups, num_denoise_queries, num_classes)
    assert denoise_output.logits.shape == expected_denoise_logits_shape
